...
extern _Bool call_can_change_color (void);
_Bool call_can_change_color (void)
{
...
extern int call_clearok (WINDOW * a1, _Bool z);
int call_clearok (WINDOW * a1, _Bool z)
{
...
extern _Bool call_has_colors (void);
_Bool call_has_colors (void)
{
	T((T_CALLED("has_colors()"))); returnBool(has_colors());
}
extern _Bool call_has_ic (void);
_Bool call_has_ic (void)
{
	T((T_CALLED("has_ic()"))); returnBool(has_ic());
}
extern _Bool call_has_il (void);
_Bool call_has_il (void)
{
...
extern void call_idcok (WINDOW * a1, _Bool z);
void call_idcok (WINDOW * a1, _Bool z)
{
	T((T_CALLED("idcok(%p,%#lx)"), (const void *)a1, (long)z)); idcok(a1, z);
	returnVoid;
}
extern int call_idlok (WINDOW * a1, _Bool z);
int call_idlok (WINDOW * a1, _Bool z)
{
	T((T_CALLED("idlok(%p,%#lx)"), (const void *)a1, (long)z)); returnCode(idlok(a1, z));
}
extern void call_immedok (WINDOW * a1, _Bool z);
void call_immedok (WINDOW * a1, _Bool z)
{
...
extern int call_intrflush (WINDOW * a1, _Bool z);
int call_intrflush (WINDOW * a1, _Bool z)
{
	T((T_CALLED("intrflush(%p,%#lx)"), (const void *)a1, (long)z)); returnCode(intrflush(a1, z));
}
extern _Bool call_isendwin (void);
_Bool call_isendwin (void)
{
	T((T_CALLED("isendwin()"))); returnBool(isendwin());
}
extern _Bool call_is_linetouched (WINDOW * a1, int z);
_Bool call_is_linetouched (WINDOW * a1, int z)
{
	T((T_CALLED("is_linetouched(%p,%d)"), (const void *)a1, z)); returnBool(is_linetouched(a1, z));
}
extern _Bool call_is_wintouched (WINDOW * z);
_Bool call_is_wintouched (WINDOW * z)
{
...
extern int call_keypad (WINDOW * a1, _Bool z);
int call_keypad (WINDOW * a1, _Bool z)
{
...
extern int call_leaveok (WINDOW * a1, _Bool z);
int call_leaveok (WINDOW * a1, _Bool z)
{
...
extern int call_meta (WINDOW * a1, _Bool z);
int call_meta (WINDOW * a1, _Bool z)
{
...
extern int call_nodelay (WINDOW * a1, _Bool z);
int call_nodelay (WINDOW * a1, _Bool z)
{
...
extern int call_notimeout (WINDOW * a1, _Bool z);
int call_notimeout (WINDOW * a1, _Bool z)
{
...
extern int call_scrollok (WINDOW * a1, _Bool z);
int call_scrollok (WINDOW * a1, _Bool z)
{
...
extern int call_syncok (WINDOW * a1, _Bool z);
int call_syncok (WINDOW * a1, _Bool z)
{
...
extern void call_use_env (_Bool z);
void call_use_env (_Bool z)
{
...
extern _Bool call_is_cleared (const WINDOW * z);
_Bool call_is_cleared (const WINDOW * z)
{
	T((T_CALLED("is_cleared(%p)"), (const void *)z)); returnBool(((z) ? (z)->_clear : 0));
}
extern _Bool call_is_idcok (const WINDOW * z);
_Bool call_is_idcok (const WINDOW * z)
{
	T((T_CALLED("is_idcok(%p)"), (const void *)z)); returnBool(((z) ? (z)->_idcok : 0));
}
extern _Bool call_is_idlok (const WINDOW * z);
_Bool call_is_idlok (const WINDOW * z)
{
	T((T_CALLED("is_idlok(%p)"), (const void *)z)); returnBool(((z) ? (z)->_idlok : 0));
}
extern _Bool call_is_immedok (const WINDOW * z);
_Bool call_is_immedok (const WINDOW * z)
{
	T((T_CALLED("is_immedok(%p)"), (const void *)z)); returnBool(((z) ? (z)->_immed : 0));
}
extern _Bool call_is_keypad (const WINDOW * z);
_Bool call_is_keypad (const WINDOW * z)
{
	T((T_CALLED("is_keypad(%p)"), (const void *)z)); returnBool(((z) ? (z)->_use_keypad : 0));
}
extern _Bool call_is_leaveok (const WINDOW * z);
_Bool call_is_leaveok (const WINDOW * z)
{
	T((T_CALLED("is_leaveok(%p)"), (const void *)z)); returnBool(((z) ? (z)->_leaveok : 0));
}
extern _Bool call_is_nodelay (const WINDOW * z);
_Bool call_is_nodelay (const WINDOW * z)
{
	T((T_CALLED("is_nodelay(%p)"), (const void *)z)); returnBool(((z) ? ((z)->_delay == 0) : 0));
}
extern _Bool call_is_notimeout (const WINDOW * z);
_Bool call_is_notimeout (const WINDOW * z)
{
	T((T_CALLED("is_notimeout(%p)"), (const void *)z)); returnBool(((z) ? (z)->_notimeout : 0));
}
extern _Bool call_is_pad (const WINDOW * z);
_Bool call_is_pad (const WINDOW * z)
{
	T((T_CALLED("is_pad(%p)"), (const void *)z)); returnBool(((z) ? ((z)->_flags & 0x10) != 0 : 0));
}
extern _Bool call_is_scrollok (const WINDOW * z);
_Bool call_is_scrollok (const WINDOW * z)
{
	T((T_CALLED("is_scrollok(%p)"), (const void *)z)); returnBool(((z) ? (z)->_scroll : 0));
}
extern _Bool call_is_subwin (const WINDOW * z);
_Bool call_is_subwin (const WINDOW * z)
{
	T((T_CALLED("is_subwin(%p)"), (const void *)z)); returnBool(((z) ? ((z)->_flags & 0x01) != 0 : 0));
}
extern _Bool call_is_syncok (const WINDOW * z);
_Bool call_is_syncok (const WINDOW * z)
{
...
#endif
#if USE_SP_FUNC_SUPPORT
extern _Bool call_NCURSES_SP_NAME___can_change_color (SCREEN * z);
_Bool call_NCURSES_SP_NAME___can_change_color (SCREEN * z)
{
...
#endif
#if USE_SP_FUNC_SUPPORT
extern _Bool call_NCURSES_SP_NAME___has_colors (SCREEN * z);
_Bool call_NCURSES_SP_NAME___has_colors (SCREEN * z)
{
	T((T_CALLED("NCURSES_SP_NAME(has_colors)(%p)"), (const void *)z)); returnBool(NCURSES_SP_NAME(has_colors)(z));
}
#endif
#if USE_SP_FUNC_SUPPORT
extern _Bool call_NCURSES_SP_NAME___has_ic (SCREEN * z);
_Bool call_NCURSES_SP_NAME___has_ic (SCREEN * z)
{
	T((T_CALLED("NCURSES_SP_NAME(has_ic)(%p)"), (const void *)z)); returnBool(NCURSES_SP_NAME(has_ic)(z));
}
#endif
#if USE_SP_FUNC_SUPPORT
extern _Bool call_NCURSES_SP_NAME___has_il (SCREEN * z);
_Bool call_NCURSES_SP_NAME___has_il (SCREEN * z)
{
...
#endif
#if USE_SP_FUNC_SUPPORT
extern int call_NCURSES_SP_NAME___intrflush (SCREEN * a1, WINDOW * a2, _Bool z);
int call_NCURSES_SP_NAME___intrflush (SCREEN * a1, WINDOW * a2, _Bool z)
{
...
#endif
#if USE_SP_FUNC_SUPPORT
extern _Bool call_NCURSES_SP_NAME___isendwin (SCREEN * z);
_Bool call_NCURSES_SP_NAME___isendwin (SCREEN * z)
{
...
#endif
#if USE_SP_FUNC_SUPPORT
extern void call_NCURSES_SP_NAME___use_env (SCREEN * a1, _Bool z);
void call_NCURSES_SP_NAME___use_env (SCREEN * a1, _Bool z)
{
...
#endif
#if USE_EXT_SP_FUNC_SUPPORT
extern _Bool call_NCURSES_SP_NAME___is_term_resized (SCREEN * a1, int a2, int z);
_Bool call_NCURSES_SP_NAME___is_term_resized (SCREEN * a1, int a2, int z)
{
...
#endif
#if USE_EXT_SP_FUNC_SUPPORT
extern int call_NCURSES_SP_NAME___keyok (SCREEN * a1, int a2, _Bool z);
int call_NCURSES_SP_NAME___keyok (SCREEN * a1, int a2, _Bool z)
{
...
#endif
extern _Bool call_mouse_trafo (int * a1, int * a2, _Bool z);
_Bool call_mouse_trafo (int * a1, int * a2, _Bool z)
{
